...
const TermsPage = () => {
  return (
    <div  className={clsx("block  ")}>
      ...
      <div
        className={clsx(
          "absolute w-full  top-0 left-0 bottom-0 flex flex-col items-stretch justify-evenly "
        )}
      >
      ...
      <div className="relative max-w-[882px] mx-auto -xl:max-w-[95%] h-fit">
        <Typography
          variant="h1"
          className="relative tracking-tight pt-10 pb-5  leading-[50px] "
          color="white"
        >
        ...
        <Typography variant="paragraph" className=" text-[#ffffff7c] py-4">
          ...
          <ul className=" list-disc ml-3 my-3 list-outside">
            ...
            <li className="my-2">Country refers to: Arizona, United States</li>
            <li className="my-2">
              Company (referred to as either "the Company", "We", "Us" or "Our"
              in this Agreement) refers to RealEstate Crypto.
            </li>
            <li className="my-2">
              Device means any device that can access the Service such as a
              computer, a cellphone or a digital tablet.
            </li>
            <li className="my-2">Service refers to the Website.</li>
            <li className="my-2">
            ...
            <li className="my-2">
              Website refers to RealEstate Crypto, accessible from
              https://realestatecrypto.com
            </li>
            <li className="my-2">
        ...
        <Typography variant="paragraph" className=" text-[#ffffff7c] py-3">
          ...
          on applicable statutory rights of a consumer, so some or all of the
