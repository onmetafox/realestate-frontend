...
const Steps = [
  ...
  },
  {
    ...
    description:
      "These wallets can be found in the appstore. We recommend coinbase wallet. Download and open the app on your phone and connect by scanning the QR code from within the app.",
  },
  {
    title: "Polygon Network on Coinbase Wallet",
    description:
      "Once connected, use your desktop and click on the dropdown next to your coinbase wallet, here you can choose the polygon network.",
  },
  {
    title: "Buying Polygon for TLT Swaps",
    description:
      "Here you can buy Polygon (Matic) and use it to swap it for TLT. ",
  },
];

const SectionUniswap: React.FC = () => {
  return (
    <div id="section-unsiwap" className="mt-20 relative  bg-repeat">
      ...
      <div className="w-full flex flex-col items-center gap-5 mt-10 -md:w-[90%] mx-auto">
        <Typography
          variant="paragraph"
          color="white"
          className="flex-1 text-white leading-[22px] text-center w-1/2 -md:w-3/4"
        >
            Buy Now with Simplified Purchases Via Credit Card<br />
            Store on our Platform or Provide Your Uniswap Wallet and we will transfer your tokens.<br />
            Click here to buy here today!<br />
            OR
        </Typography>
        ...
        <Typography
          variant="h1"
          color="white"
          className="flex-[3] max-w-[741px] tracking-tighter text-center -2md:text-[32px]"
        >
        ...
        <Typography
          variant="paragraph"
          color="white"
          className="flex-1 text-[#ffffff7c] text-center w-1/2 -md:w-3/4"
        >
          Discover our tokens available for purchase on Uniswap, the leading
        ...
        <div className="pt-10 grid grid-cols-2 gap-6 -2md:grid-cols-1">
          {Steps.map((_, index) => {
            return (
              <div
                key={"su_" + index}
                className=" rounded-[24px] border-2 border-[#3A3C3F] p-6 bg-[#1E1F23]"
              >
                ...
                <Typography
                  variant="h3"
                  color="white"
                  className="flex-[3] font-trapReg max-w-[741px] tracking-tighter my-6 -2md:text-[24px] -md:text-[18px]"
                >
                  {_.title}
                </Typography>
      ...
      <div className="w-full flex flex-col items-center gap-5 mt-40">
        <Typography
          variant="h1"
          color="white"
          className="flex-[3] max-w-[792px] tracking-tighter text-center -2md:text-[32px]"
        >
        ...
        <Typography
          variant="paragraph"
          color="white"
          className="flex-1 text-[#ffffff7c] text-center w-1/3 -md:w-3/4"
        >
          Please contact our team if you are having issues with this process and
